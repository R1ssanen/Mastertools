...
namespace {
    core::u64 s_MaxParticleID = 0;
}

namespace core {

    Particle Particle::New(const glm::vec3& Pos,
    ...
    emitter_t SphericalEmitter::New(mesh_t Mesh, u64 ParticleCap, const glm::vec3& Pos, f32 Radius) {
    ...
    void DiskEmitter::Emit() {
        ...
        Particle Particle = Particle::New(
            ...
            glm::vec3(0.3f),
            glm::vec3(0.f, glm::linearRand(0.f, -0.00015f), 0.f),
