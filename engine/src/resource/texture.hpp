...
namespace mt {
    ...
    class ImageData {
      public:
        ...
        ImageData(u32* Data, u32 Width, u32 Height)
            : Data{ Data }, m_Width{ Width }, m_Height{ Height }, m_Resolution{ Width * Height } { }
    ...
    class Texture {
      public:
        ...
        Texture(const std::string& Name, u32& ID, b8 IsTransparent, b8 IsDoublesided)
    ...
    class ImageTexture : public Texture {
      public:
        ...
        ImageTexture(
            image_t Image, const std::string& Name, u32 ID, b8 IsTransparent, b8 IsDoublesided
        )
    ...
    class MipmapTexture : public Texture {
      public:
        ...
        MipmapTexture(
            const std::vector<image_t>& Mipmap, u8 Miplevels, const std::string& Name, u32 ID,
            b8 IsTransparent, b8 IsDoublesided
        )
    ...
    class AnimatedTexture
      ...
      public:
        ...
        AnimatedTexture(
            const std::vector<image_t>& ImageFrames, f32 PlaybackSpeed, const std::string& Name,
            u32 ID, b8 IsTransparent, b8 IsDoublesided
        )
            : MipmapTexture(
                  ImageFrames, static_cast<u8>(ImageFrames.size()), Name, ID, IsTransparent,
                  IsDoublesided
              ),
    ...
    class ColorTexture : public Texture {
      public:
        ...
        ColorTexture(
            const u32& Color, const std::string& Name, u32 ID, b8 IsTransparent, b8 IsDoublesided
        )
