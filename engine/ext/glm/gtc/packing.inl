...
struct compute_half<1, Q> {
  ...
  GLM_FUNC_QUALIFIER static vec<1, float, Q> unpack(
      vec<1, uint16, Q> const& v) {
    i16vec1 Unpack;
...
struct compute_half<2, Q> {
  GLM_FUNC_QUALIFIER static vec<2, uint16, Q> pack(vec<2, float, Q> const& v) {
    vec<2, int16, Q> const Unpack(detail::toFloat16(v.x),
  ...
  GLM_FUNC_QUALIFIER static vec<2, float, Q> unpack(
      vec<2, uint16, Q> const& v) {
    i16vec2 Unpack;
    memcpy(&Unpack, &v, sizeof(Unpack));
...
struct compute_half<3, Q> {
  GLM_FUNC_QUALIFIER static vec<3, uint16, Q> pack(vec<3, float, Q> const& v) {
    vec<3, int16, Q> const Unpack(
        detail::toFloat16(v.x), detail::toFloat16(v.y), detail::toFloat16(v.z));
    u16vec3 Packed;
    memcpy(&Packed, &Unpack, sizeof(Packed));
    return Packed;
  }

  GLM_FUNC_QUALIFIER static vec<3, float, Q> unpack(
      vec<3, uint16, Q> const& v) {
    i16vec3 Unpack;
    memcpy(&Unpack, &v, sizeof(Unpack));
...
struct compute_half<4, Q> {
  ...
  GLM_FUNC_QUALIFIER static vec<4, float, Q> unpack(
      vec<4, uint16, Q> const& v) {
    i16vec4 Unpack;
    memcpy(&Unpack, &v, sizeof(Unpack));
...
GLM_FUNC_QUALIFIER vec4 unpackSnorm3x10_1x2(uint32 v) {
  ...
  return clamp(Result * vec4(1.f / 511.f, 1.f / 511.f, 1.f / 511.f, 1.f), -1.0f,
               1.0f);
}
...
GLM_FUNC_QUALIFIER uint32 packF3x9_E1x5(vec3 const& v) {
  ...
  float const ExpShared = equal(MaxShared, pow(2.0f, 9.0f), epsilon<float>())
                              ? ExpSharedP + 1.0f
                              : ExpSharedP;
...
GLM_FUNC_QUALIFIER vec<4, T, Q> packRGBM(vec<3, T, Q> const& rgb) {
  ...
  T Alpha =
      clamp(max(max(Color.x, Color.y), max(Color.z, static_cast<T>(1e-6))),
...
GLM_FUNC_QUALIFIER vec<L, uintType, Q> packUnorm(
    vec<L, floatType, Q> const& v) {
...
GLM_FUNC_QUALIFIER vec<L, floatType, Q> unpackUnorm(
    vec<L, uintType, Q> const& v) {
  GLM_STATIC_ASSERT(std::numeric_limits<uintType>::is_integer,
                    "uintType must be an integer type");
  GLM_STATIC_ASSERT(std::numeric_limits<floatType>::is_iec559,
                    "floatType must be a floating point type");
...
GLM_FUNC_QUALIFIER vec<L, floatType, Q> unpackSnorm(
    vec<L, intType, Q> const& v) {
  GLM_STATIC_ASSERT(std::numeric_limits<intType>::is_integer,
                    "uintType must be an integer type");
  GLM_STATIC_ASSERT(std::numeric_limits<floatType>::is_iec559,
                    "floatType must be a floating point type");
